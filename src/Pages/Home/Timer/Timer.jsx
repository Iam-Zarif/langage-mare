...
const Timer = () => {
  ...
  useEffect(() => {
    const deadline = new Date("2025-05-28"); // Set the date and time when the offer will end
      ...
      <div className="mt-36">
        ...
        <div className="mt-16">
          ...
          <div className="text-center">
            <div className="justify-center items-center mt-10 grid grid-flow-col gap-5 text-center auto-cols-max">
